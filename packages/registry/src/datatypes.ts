...
export const BUILTIN_TYPES: DataType[] = [
  ...
  t("CREDENTIAL", "Credential or secret (any)", ["credential", "credentials", "secret", "secrets", "api key", "api keys", "apikey", "password", "passwords", "token", "tokens", "auth token", "authentication token", "authentication tokens", "access token", "access tokens", "bearer token", "client secret", "client secrets", "private key", "private keys", "key", "keys", "aws key", "aws keys", "jwt", "other credentials", "signing key", "certificate private key"], { inputs: ["text", "table", "structured", "code"], transforms: NO_TRANSFORM, actions: NO_CONSTRAIN, defaults: { minCount: 1, minConfidence: "medium" }, legacyKind: "secret" }),
  ...
  t("CREDENTIAL.CREDENTIAL_FILE", "Credential file (by name)", ["credential file", "credential files", "env file", "dotenv", ".env", "keyfile", "kubeconfig", "netrc", "htpasswd", "id rsa"], { inputs: ["metadata", "any"], transforms: NO_TRANSFORM, actions: NO_CONSTRAIN, legacyKind: "credential_file" }),
